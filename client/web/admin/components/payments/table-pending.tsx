...
export const TablePending = ({ refunds }: { refunds: any }) => {
        ...
        return (
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-500 bg-opacity-50">
                <div className="bg-white w-full md:w-1/2 lg:w-1/2 xl:w-1/2 rounded-lg shadow-lg p-6 relative">
                    ...
                    <p>
                        Bạn có chắc chắn muốn xử lý yêu cầu cho người dùng này ? *Lưu ý: Bạn phải chịu trách nhiệm trước với kết quả xét duyệt của mình.
                    </p>
                    <div className="flex justify-end mt-4">
                        ...
                        <div className="flex justify-end mt-4">
                            <button className="bg-gray-500 text-white px-4 py-2 rounded-md" onClick={handleConfirm}>Tiến hành xử lý</button>
                        </div>
                        <div className="flex justify-end mt-4">
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            <Table>
                ...
                <TableBody>
                    {
                        refunds.filter((refund: any) => refund.status === 1).map((refund: any, index: number) => (
                            <TableRow key={index}>
                                <TableCell>
                                    <span>
