...
const AboutSection = () => {
  return (
    <div className="about-section" id="about" style={{ padding: 32 }}>
  <Container>
    <Row className="align-items-center">
      <Col md={6} className="about-image-content">
        <img src={Doctor} alt="Doctor Group" className="about-image1 img-fluid" />
      </Col>
      <Col md={6} className="about-text-content">
