...
import ReExaminationSchdedule from '../components/re_examination_schedule';
import React from 'react';
import { Grid, Box, Breadcrumbs, Link, Typography } from '@mui/material';
import Header from '../components/Header';

function ReExaminationSchedulePage() {
    return (
        <>
...
export default ReExaminationSchedulePage; 
