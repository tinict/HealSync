import BulterHandelSubcription from "./HandleSubscription/bulter.sub";
...
async function ZealSyncSubscriber (zealClient: any) {
    ...
    zealClient.instanceConnect.subscribe('request-mission', ResponeTaskHandelSubcription);
    zealClient.instanceConnect.subscribe('collect-task', BulterHandelSubcription);
