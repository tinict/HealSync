...
import Appointment from '../components/main_schedule/Appointment';
import React from 'react';
import { Grid, Box, Breadcrumbs, Link, Typography } from '@mui/material';
import Header from '../components/Header';

function AppointmentSchedulPage() {
    return (
        <>
                ...
                <Grid item xs={12} md={11} style={{ marginTop: '64px', marginLeft: '80px' }}>
                    <Box sx={{ p: 2, bgcolor: 'background.paper' }}>
                        <Breadcrumbs separator="/" aria-label="breadcrumb">
                            ...
                            <Typography color="textPrimary">Quản lý lịch đặt khám</Typography>
                        </Breadcrumbs>
                        <Appointment />
                    </Box>
                </Grid>
...
export default AppointmentSchedulPage; 
